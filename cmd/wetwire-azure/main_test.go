...
// Note: Tests for runTest and runDesign internal functions removed.
// These functions now take individual parameters instead of []string args.
// The behavior is covered by cobra command integration tests.
