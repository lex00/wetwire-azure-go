...
Navigate the wetwire-azure-go documentation by your goal.
...
### New Users
1. [QUICK_START.md](QUICK_START.md) - Build your first ARM template
...
- [LINT_RULES.md](LINT_RULES.md) - All WAZ rules with examples
- [TROUBLESHOOTING.md](TROUBLESHOOTING.md) - Common errors and solutions

### Team Adoption
- [ADOPTION.md](ADOPTION.md) - Migration strategies and team onboarding
- [IMPORT_WORKFLOW.md](IMPORT_WORKFLOW.md) - Convert existing ARM/Bicep templates
...
| [LINT_RULES.md](LINT_RULES.md) | WAZ001-WAZ499 rule reference | All users |
